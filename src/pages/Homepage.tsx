        ...
        <section id="how-it-works" className="px-4 py-24 md:py-32 bg-black">
          <div className="container mx-auto max-w-7xl">
            ...
            <p className="text-xl md:text-2xl text-white font-extralight text-center max-w-3xl mx-auto mb-20">
              A text-based journaling tool that makes it quick and easy for fathers reflect, organize, and preserve their wisdom — <span className="font-bold">one message at a time.</span>
            </p>
