          ...
          <div className="container mx-auto max-w-6xl">
            <div className="flex flex-col lg:grid lg:grid-cols-2 lg:gap-12 lg:items-center">
              ...
              <div className="text-center lg:text-left space-y-4 md:space-y-5 lg:space-y-6">
                ...
                <p className="text-base sm:text-lg md:text-xl text-white leading-relaxed font-bold">LegacyText is an app for dads.
Answer daily text prompts — we turn your words into a book your kids will keep forever.</p>
