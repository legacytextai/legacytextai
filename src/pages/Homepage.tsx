          ...
          <div className="container mx-auto max-w-6xl">
            <div className="flex flex-col lg:grid lg:grid-cols-2 lg:gap-12 lg:items-center">
              ...
              <div className="text-center lg:text-left space-y-4 md:space-y-5 lg:space-y-6">
                ...
                <p className="text-base sm:text-lg md:text-xl text-white leading-relaxed font-thin"><span className="font-bold">LegacyText is an app for dads.</span> Answer daily text prompts — we turn your words into a book your kids will keep forever.</p>
              ...
              <div className="mt-6 lg:mt-0">
                <div className="rounded-xl md:rounded-2xl border border-white/10 overflow-hidden w-fit mx-auto">
                  <video className="w-full max-h-[450px] lg:max-h-[500px] object-contain" autoPlay muted loop playsInline>
        ...
        <section id="how-it-works" className="px-4 py-24 md:py-32 bg-black">
          <div className="container mx-auto max-w-7xl">
            ...
            <p className="text-xl md:text-2xl text-white font-extralight text-center max-w-3xl mx-auto mb-20">
              A text-based journaling tool that makes it <em>quick</em> and <em>easy</em> for fathers to reflect, organize, and preserve their wisdom — <span className="font-bold">one message at a time.</span>
            </p>
